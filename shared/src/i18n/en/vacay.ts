...
const vacay: TranslationStrings = {
  ...
  'vacay.inviteUser': 'Add Member',
  'vacay.inviteHint': 'Select a registered user and add them directly to this shared workspace.',
  'vacay.selectUser': 'Select user',
  'vacay.sendInvite': 'Add Member',
  'vacay.inviteSent': 'Member added',
  'vacay.inviteError': 'Could not add member',
