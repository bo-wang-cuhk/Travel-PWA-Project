export type SyncEntityType = 'trip' | 'day' | 'dayNote' | 'category' | 'collection' | 'collectionPlace' | 'journey' | 'journeyEntry' | 'place' | 'assignment' | 'accommodation' | 'reservation' | 'budgetItem' | 'todo' | 'packingBag' | 'packingItem' | 'packingConfig' | 'tripFile' | 'vacay' | 'atlas'
