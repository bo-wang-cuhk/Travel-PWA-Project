...
export const DEFAULT_SETTINGS: Settings = {
  ...
  // language (written by loadSettings below), then Simplified Chinese. Without the mirror
  // an offline cold start uses the product default: the account's language lives on the
  // server, and the fetch that would apply it cannot happen.
  language: localStorage.getItem('app_language') || localStorage.getItem(SERVER_LANGUAGE_KEY) || 'zh',
