...
// loader plumbing: Simplified Chinese and English are synchronous, everything else arrives one tick later.
...
describe('TranslationProvider', () => {
  it('FE-COMP-I18NCTX-001: resolves a key from the default Simplified Chinese table', () => {
    render(<TranslationProvider><Probe tKey="common.save" /></TranslationProvider>);
    expect(screen.getByTestId('value').textContent).not.toBe('Save');
  });
  ...
  it('FE-COMP-I18NCTX-004: defaults to Simplified Chinese with the matching locale', () => {
    render(<TranslationProvider><Probe tKey="common.save" /></TranslationProvider>);
  ...
  it('FE-COMP-I18NCTX-010: treats an empty language setting as Simplified Chinese', () => {
    withLanguage('');
    render(<TranslationProvider><Probe tKey="common.save" /></TranslationProvider>);
    expect(screen.getByTestId('language').textContent).toBe('zh');
  });
